...
\addtitle{Használati eset:}{Template test} 

%Scope: the system under design
%\addfield{Scope:}{System-wide}

%Level: "user-goal" or "subfunction"
\addfield{Szint:}{User-goal}

%Primary Actor: Calls on the system to deliver its services.
\addfield{Elsődleges aktor:}{End-User}
...
\addfield{Sikeres végrehajtás (utófeltételek):}{}
%when multiple
